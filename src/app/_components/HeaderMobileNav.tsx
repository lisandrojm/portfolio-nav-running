...
export default function MobileNav() {
  ...
  return (
    <div>
      ...
      <div className={`fixed left-0 top-0 z-100 h-full w-full transform inset-0 backdrop-blur border-l-[1px] border-orange duration-300 ease-in-out ${navShow ? 'translate-x-0' : 'translate-x-full'}`}>
        <SectionContainer>
